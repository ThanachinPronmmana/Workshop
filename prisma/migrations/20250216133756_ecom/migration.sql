...
CREATE TABLE `User` (
    ...
    `createdAdd` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAdd` DATETIME(3) NOT NULL,
...
CREATE TABLE `Order` (
    ...
    `cratedAdd` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAdd` DATETIME(3) NOT NULL,
